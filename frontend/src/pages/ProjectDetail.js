...
const ProjectDetail = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Back nav */}
      <div className="border-b border-white/5 bg-black/40 backdrop-blur-xl sticky top-20 md:top-24 z-30">
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <h2 className="font-display text-2xl font-light text-white mb-6">About this project</h2>
      ...
      {images.length > 1 && (
        <section className="py-12 md:py-16 border-t border-neutral-100">
          <div className="container mx-auto px-4 md:px-6 lg:px-8">
            <h2 className="font-display text-2xl font-light text-white mb-10">Gallery</h2>
      ...
      <section className="py-16 border-t border-neutral-100">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <p className="text-slate-400 mb-6">View more of our work or start your own project.</p>
