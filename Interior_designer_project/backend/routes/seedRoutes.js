...
const seedProjects = [
    ...
    },
    {
        ...
        description: "A master bedroom that redefines luxury. Velvet upholstery, gold leaf accents, and a custom-designed headboard create a regal sanctuary.",
    ...
    },
    {
        ...
        description: "Sculptural furniture and a monochromatic palette define this dining space. A custom marble table serves as the centerpiece.",
    ...
    },
    {
        ...
        description: "Transforming the daily routine into a spa experience. Features a freestanding soaking tub, rainforest shower, and premium Italian marble finishes.",
...
// GET /api/seed?key=YOUR_SECRET_KEY
router.get("/", async (req, res) => {
    const SECRET = process.env.SEED_SECRET || "seed-interior-2026";
