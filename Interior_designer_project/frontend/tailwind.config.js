...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "luxury-gradient": "linear-gradient(135deg, #FAFAF9 0%, #F5F5F4 100%)",
        "cream-gradient": "linear-gradient(to bottom right, #FFFFFF, #F1F5F9)",
        "sand-gradient": "linear-gradient(135deg, #F8FAFC 0%, #E2E8F0 100%)",
        "hero-overlay": "linear-gradient(to bottom, rgba(15, 23, 42, 0.6), rgba(15, 23, 42, 0.8))",
